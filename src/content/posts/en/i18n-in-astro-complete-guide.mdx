---
title: 'Astro 5 i18n Guide - Multilingual Site Without Libraries'
pubDate: 2026-03-11
description: 'Complete guide to adding i18n to Astro 5 from scratch. Routing, translations, hreflang, sitemap, content collections - no next-intl, no plugins needed.'
...
If you're looking to self-host your Astro site after setting up i18n, check out my guide on [deploying Astro 5 on Dokploy](/en/blog/deploying-astro-on-dokploy/) - the same site this i18n system runs on.
