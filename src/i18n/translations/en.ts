    ...
    jobs: [
      {
        ...
        bullets: [
          ...
          'Designed a 4-tier Nx architecture with 5 domain modules (Next.js, Strapi CMS). Built the project\'s Design System (20+ components) with Ark UI and Storybook.',
          'Solo frontend developer on Maspex Photo Service: rebuilt the photo service app and admin panel for a major FMCG company. Delivered in under 6 months. Optimized bundle size by ~30%.',
          'Monitor production stability via Sentry alerts integrated with Slack. Manage releases and deployment pipelines.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Wrote an AI-powered i18n tool for CI/CD that auto-generated translations for 15+ languages across ~1,500 keys.',
          'Set up CI/CD pipelines (GitHub Actions) for automated deployments across multiple projects.',
        ],
      },
    ],
  },
