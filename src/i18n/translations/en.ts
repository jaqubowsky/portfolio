    ...
    jobs: [
      {
        ...
        location: 'Remote',
        bullets: [
          'Full technical ownership of the Dubai Real Estate platform. Responsible for architecture, releases, code reviews, and stakeholder communication.',
          'Co-designed and implemented a 4-tier Nx architecture with 5 domain modules (Next.js, Strapi CMS). Built the project\'s Design System (20+ components) with Ark UI and Storybook.',
          'Estimate tasks and translate business requirements into technical specs across projects. Delivered both Maspex milestones (2x 3 months) ahead of schedule, leaving time for polish.',
          'Solo frontend developer on Maspex Photo Service: rebuilt the photo service app and admin panel for a major FMCG company. Optimized bundle size by ~30%. On-time delivery led to promotion to Project Lead within 3 months.',
          'Created a custom component library on Shadcn UI with Turborepo and Next.js. Feature-driven development approach.',
          'Integrated AI-powered animation generation from prompts and images into the platform.',
          'Production monitoring with Sentry → Slack alerts, so the team reacts to issues instantly. Set up CI/CD checks on every PR (linting, type-checking) and Husky pre-commit hooks to catch issues early.',
          'Delivered a homepage redesign for the TwoContinents travel platform.',
        ],
      },
      {
        company: 'Haergi',
        ...
        bullets: [
          ...
          'Developed a B2B e-commerce platform for Mezze Foods (Warsaw restaurant) on top of InstagoAI, integrated with LeadMe AI for orders, invoicing, and client messaging. Handled 3,500+ orders/month.',
          'Wrote an AI-powered i18n tool for CI/CD that auto-generated translations for 15+ languages across ~1,500 keys, removing manual translation work from all company projects.',
        ],
      },
    ],
  },
