    ...
    jobs: [
      {
        ...
        bullets: [
          ...
          'Zaprojektowałem 4-warstwową architekturę w Nx z 5 modułami domenowymi (Next.js, Strapi CMS). Zbudowałem Design System (20+ komponentów) z Ark UI i Storybook.',
          'Jedyny frontend developer na Maspex Photo Service - przebudowałem aplikację foto serwisu i panel administracyjny dla dużej firmy FMCG. Dostarczono w niecałe 6 miesięcy. Optymalizacja bundle\'a o ~30%.',
          'Monitoruję stabilność produkcji przez alerty Sentry zintegrowane ze Slackiem. Zarządzam releasami i pipeline\'ami deploymentu.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Napisałem narzędzie AI do i18n w CI/CD - automatyczne generowanie tłumaczeń dla 15+ języków w ~1500 kluczach.',
          'Postawiłem pipeline\'y CI/CD (GitHub Actions) do automatycznych deploymentów w wielu projektach.',
        ],
      },
    ],
  },
