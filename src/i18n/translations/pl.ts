    ...
    jobs: [
      {
        ...
        location: 'Zdalnie',
        bullets: [
          'Pełna odpowiedzialność techniczna za platformę Dubai Real Estate. Odpowiadam za architekturę, releasy, code review i komunikację z biznesem.',
          'Współprojektowałem i wdrożyłem 4-warstwową architekturę w Nx z 5 modułami domenowymi (Next.js, Strapi CMS). Zbudowałem Design System (20+ komponentów) z Ark UI i Storybook.',
          'Estymacja zadań i tłumaczenie wymagań biznesowych na specyfikacje techniczne w wielu projektach. Oba milestone\'y Maspex (2x 3 miesiące) dostarczone przed terminem, z zapasem czasu na szlify.',
          'Jedyny frontend developer na Maspex Photo Service - przebudowałem aplikację foto serwisu i panel administracyjny dla dużej firmy FMCG. Optymalizacja bundle\'a o ~30%. Terminowe dostarczenie projektu doprowadziło do awansu na Project Leada w 3 miesiące.',
          'Stworzyłem własną bibliotekę komponentów na Shadcn UI z Turborepo i Next.js. Podejście feature-driven.',
          'Zintegrowałem generowanie animacji AI z promptów i obrazów w platformie.',
          'Monitoring produkcji z alertami Sentry → Slack, zespół reaguje na problemy natychmiast. CI/CD checks na każdym PR (linting, type-checking) i Husky pre-commit hooks.',
          'Dostarczyłem redesign strony głównej platformy turystycznej TwoContinents.',
        ],
      },
      {
        company: 'Haergi',
        ...
        bullets: [
          ...
          'Zbudowałem platformę e-commerce B2B dla Mezze Foods (warszawska restauracja) na bazie InstagoAI, zintegrowaną z LeadMe AI do zamówień, fakturowania i komunikacji z klientami. 3500+ zamówień/miesiąc.',
          'Napisałem narzędzie AI do i18n w CI/CD - automatyczne generowanie tłumaczeń dla 15+ języków w ~1500 kluczach. Wdrożone we wszystkich projektach firmy.',
        ],
      },
    ],
  },
