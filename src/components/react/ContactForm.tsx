...
const ContactForm = ({ translations }: { translations: ContactFormTranslations }) => {
  ...
  return (
    <form className="space-y-3 w-full mt-2" onSubmit={onSubmit}>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Label>
          {translations.name}
          <Input name="name" type="text" placeholder={translations.namePlaceholder} required />
        </Label>

        <Label>
          {translations.email}
          <Input name="email" type="email" placeholder={translations.emailPlaceholder} required />
        </Label>
      </div>

      <Label>
        {translations.message}
        <Textarea name="message" placeholder={translations.messagePlaceholder} rows={5} required />
      </Label>
